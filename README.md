...
| Parameter name   | Description                                                                                                                                                    | Default value |
|------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------|
| `diskann.parallel_flush_rate` | The number of tuples processed before flushing neighbor cache in parallel builds | 4096 |
...
-- Adjust cache flushing frequency for memory usage
SET diskann.parallel_flush_rate = 2048;

...
-- vectorscale::access_method::amhandler
    ...
    CREATE OR REPLACE FUNCTION diskann_amhandler(internal) RETURNS index_am_handler PARALLEL SAFE IMMUTABLE STRICT COST 0.0001 LANGUAGE c AS '$libdir/vectorscale-0.6.0-dev', 'amhandler_wrapper';
...
LANGUAGE c /* Rust */
AS '$libdir/vectorscale-0.6.0-dev', 'distance_type_cosine_wrapper';
/* </end connected objects> */

/* <begin connected objects> */
-- pgvectorscale/src/access_method/distance.rs:57
-- vectorscale::access_method::distance::distance_type_inner_product
CREATE  FUNCTION "distance_type_inner_product"() RETURNS smallint /* i16 */
IMMUTABLE STRICT PARALLEL SAFE
LANGUAGE c /* Rust */
AS '$libdir/vectorscale-0.6.0-dev', 'distance_type_inner_product_wrapper';
/* </end connected objects> */
...
IMMUTABLE STRICT PARALLEL SAFE
LANGUAGE c /* Rust */
AS '$libdir/vectorscale-0.6.0-dev', 'distance_type_l2_wrapper';
/* </end connected objects> */
